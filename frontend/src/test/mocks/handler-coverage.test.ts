...
const EXPECTED_ENDPOINTS = [
	...
	"GET */api/nvidia-sidecar/status",
	"GET */api/nvidia-sidecar/models",
	"POST */api/nvidia-sidecar/test",
	"GET */api/openai-compat/:endpointId/status",
	"GET */api/openai-compat/:endpointId/models",
	"POST */api/openai-compat/:endpointId/test",
