...
export function buildSettingsUpdateRequest(
  ...
  const payload: SettingsUpdateRequest = {
    ...
    nvidiaSidecarEnabled: settings.nvidiaSidecarEnabled,
    nvidiaSidecarBaseUrl: settings.nvidiaSidecarBaseUrl,
    nvidiaSidecarModelPrefixes: settings.nvidiaSidecarModelPrefixes,
    nvidiaSidecarFullModels: settings.nvidiaSidecarFullModels,
    nvidiaSidecarConnectTimeoutSeconds: settings.nvidiaSidecarConnectTimeoutSeconds,
    nvidiaSidecarRequestTimeoutSeconds: settings.nvidiaSidecarRequestTimeoutSeconds,
    nvidiaSidecarModelsCacheTtlSeconds: settings.nvidiaSidecarModelsCacheTtlSeconds,
    nvidiaSidecarDefaultReasoningEffort: settings.nvidiaSidecarDefaultReasoningEffort ?? null,
    openaiCompatEndpoints: (settings.openaiCompatEndpoints ?? []).map((endpoint) => ({
      id: endpoint.id,
      name: endpoint.name,
      ...
      connectTimeoutSeconds: endpoint.connectTimeoutSeconds ?? 8,
      requestTimeoutSeconds: endpoint.requestTimeoutSeconds ?? 600,
      modelsCacheTtlSeconds: endpoint.modelsCacheTtlSeconds ?? 60,
    ...
    opencodeGoSidecarEnabled: settings.opencodeGoSidecarEnabled,
    opencodeGoSidecarBaseUrl: settings.opencodeGoSidecarBaseUrl,
    opencodeGoSidecarModelPrefixes: settings.opencodeGoSidecarModelPrefixes,
    opencodeGoSidecarFullModels: settings.opencodeGoSidecarFullModels,
