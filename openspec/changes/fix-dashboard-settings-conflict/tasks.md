...
- [x] 3.6 `get_fresh` commits before refresh; sidecar `persistConfig` omits render `expectedVersion`; collection pre-flight skips when the cache version is this client's last write.
