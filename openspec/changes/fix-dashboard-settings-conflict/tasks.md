...
- [x] 3.6 `get_fresh` commits a clean session then refreshes; sidecar origin version advances on save and clears on failure; collection pre-flight skips only non-overlapping own writes.
