...
- Add one `ModelPrice` per canonical personality slug. Sol uses standard `$5/$0.50/$30`, Flex `$2.50/$0.25/$15`, Priority/Fast `$10/$1/$60`, and long-context `$10/$1/$45`. Terra uses standard `$2/$0.20/$12`, Flex `$1/$0.10/$6`, Priority/Fast `$4/$0.40/$24`, and long-context `$4/$0.40/$18`. Luna uses standard `$0.20/$0.02/$1.20`, Flex `$0.10/$0.01/$0.60`, Priority/Fast `$0.40/$0.04/$2.40`, and long-context `$0.40/$0.04/$1.80`. All prices are USD per 1M tokens and match the published OpenAI pricing table.
