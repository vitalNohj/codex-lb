...
- Add dashboard-managed OrcaRouter configuration (disabled by default) with encrypted API key, seeded prefix `orcarouter/` (strip off), full models, timeouts, cache TTL, and health fields.
...
- Do not edit `AGENTS.md`, `CLAUDE.md`, `CHANGELOG.md`, or `docs/`.
