"""backfill gpt-6-sol and gpt-6-luna request log costs

Revision ID: 20260922_000000_backfill_gpt_6_sol_luna_costs
Revises: 20260919_000000_add_openai_compat_endpoints
Create Date: 2026-09-22 00:00:00.000000

GPT-6 Sol and GPT-6 Luna pricing was added to ``DEFAULT_PRICING_MODELS``
after native Codex traffic had already been logged; those rows persisted
``cost_usd = NULL`` because no price resolved at insert time. Recompute
cost for historical GPT-6 Sol and GPT-6 Luna rows that now resolve so
dollar reports cover that usage. Folded usage rollups then receive a
cost-only delta for rows this migration actually repriced;
``folded_through`` is left unchanged.
